...
import { GET_EVENT_BY_ID, ADD_EVENT_COMMENT, UPDATE_EVENT_COMMENT, DELETE_EVENT_COMMENT } from '../../../services/apollo/queries';
...
export const ViewEvent = () => {
  ...
  const [deleteCommentMutation] = useMutation(
    ...
    {
      update(cache, {data: {deletCommentInEvent}}) {
  ...
  const updateComment = async(commentId: string, commentText: string) => 
    await updateCommentInEvent({ variables: { eventId: eventId, commentId: commentId, commentText: commentText } })
